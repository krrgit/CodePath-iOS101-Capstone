...
struct Split: Codable {
    ...
    init(title: String, exercises: [String]? = nil, columns: [Column]? = nil) {
        self.title = title
        self.columns = columns ?? [Column(title: "Date"), Column(title: "Log #"),Column(title: "Exer 1")]
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        columns = (try? container.decode([Column].self, forKey: .columns)) ?? [Column(title: "Date"), Column(title: "Log #"), Column(title: "Exer 1")]
